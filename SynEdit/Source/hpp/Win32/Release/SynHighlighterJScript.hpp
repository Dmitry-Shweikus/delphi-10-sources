...
// (DO NOT EDIT: machine generated header) 'SynHighlighterJScript.pas' rev: 33.00 (Windows)
...
public:
	/* TSynCustomHighlighter.Destroy */ inline __fastcall virtual ~TSynJScriptSyn() { }
