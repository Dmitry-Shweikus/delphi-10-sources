...
// (DO NOT EDIT: machine generated header) 'SynHighlighterVB.pas' rev: 33.00 (Windows)
...
private:
	...
	System::StaticArray<TIdentFuncTableFunc, 1423> fIdentFuncTable;
...
public:
	...
	__fastcall virtual TSynVBSyn(System::Classes::TComponent* AOwner);
...
public:
	/* TSynCustomHighlighter.Destroy */ inline __fastcall virtual ~TSynVBSyn() { }
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_SYNHIGHLIGHTERVB)
