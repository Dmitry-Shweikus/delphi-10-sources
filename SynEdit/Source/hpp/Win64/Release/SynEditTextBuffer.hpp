...
// (DO NOT EDIT: machine generated header) 'SynEditTextBuffer.pas' rev: 31.00 (Windows)
...
typedef System::StaticArray<TSynEditStringRec, 53687091> TSynEditStringRecList;
...
//-- var, const, procedure ---------------------------------------------------
static const int SynEditStringRecSize = int(0x28);
static const int MaxSynEditStrings = int(0x3333333);
#define NullRange (void *)(0xffffffffffffffffULL)
}	/* namespace Synedittextbuffer */
