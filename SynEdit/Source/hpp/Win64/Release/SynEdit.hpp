...
private:
	...
	void __fastcall SetBlockBegin(Synedittypes::TBufferCoord Value);
	void __fastcall SetBlockEnd(Synedittypes::TBufferCoord Value);
...
protected:
	...
	virtual void __fastcall SetCaretXYEx(bool CallEnsureCursorPos, Synedittypes::TBufferCoord Value);
...
public:
	...
	System::UnicodeString __fastcall GetWordAtRowCol(Synedittypes::TBufferCoord XY);
	...
	int __fastcall RowColToCharIndex(Synedittypes::TBufferCoord RowCol);
	...
	void __fastcall SetWordBlock(Synedittypes::TBufferCoord Value);
