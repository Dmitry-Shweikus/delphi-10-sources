...
const
  ...
  'eletestmt><setstmt><keyword text="SET"/><assignstmt er' +
  ...
  ' text="END"/><keyword text="SUB" err="err25"/></procstmt><funcstmt node=' +
  '"function"><keyword text="FUNCTION"/><ident add="name" err="err1"/><opti' +
  'onal><formalparameters/></optional><optional><asclause/></optional><eol/' +
  '><optional><statements/></optional><keyword text="END"/><keyword text="F' +
  'UNCTION" err="err26"/></funcstmt><formalparameters node="parameters"><ch' +
  'ar text="("/><optionalloop text=","><formalparam/></optionalloop><char t' +
  'ext=")" err="err7"/></formalparameters><formalparam><optionalswitch><key' +
  'word text="BYREF" node="varparams"/><keyword text="BYVAL"/></optionalswi' +
  'tch><vardecl/></formalparam></language>';
...
begin
  ...
  begin
    ...
    Insert(s1, s, i);
    fsRegisterLanguage('BasicScript', s);
  end;
end;
