...
procedure TfsSyntaxMemo.WMKillFocus(var Msg: TWMKillFocus);
begin
  inherited;
  HideCaret(Handle);
  DestroyCaret;
...
procedure TfsSyntaxMemo.WMSetFocus(var Msg: TWMSetFocus);
begin
  inherited;
...
procedure TfsSyntaxMemo.ActiveLineDraw(Y : integer; line : integer);
begin
  if ShowGutter then
    with Canvas do
...
procedure TfsSyntaxMemo.BookmarkDraw(Y : integer; line : integer);
var
  bm : integer;
begin
  if ShowGutter then
