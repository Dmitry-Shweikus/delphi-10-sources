...
var
  ...
  RegMenuShowDelayInited: Boolean = False;
function GetMenuShowDelay: Integer;
const
...
var
  ...
  TrackMouseEventUseCount: Integer = 0;
...
begin
  ...
  if TrackMouseEventUseCount <= 0 then begin
